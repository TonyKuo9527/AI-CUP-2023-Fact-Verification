...
def preprocess_input(claim, evidence_list, tokenizer, max_length):
    text = f'{claim}'
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        evidence_list = []
        evidence_list.append(self.data[index]['evidence_1'])
        evidence_list.append(self.data[index]['evidence_2'])
        evidence_list.append(self.data[index]['evidence_3'])
        evidence_list.append(self.data[index]['evidence_4'])
        evidence_list.append(self.data[index]['evidence_5'])
        label = self.data[index]['label']

        inputs = preprocess_input(
            claim, evidence_list, self.tokenizer, self.max_length)
...
file_name = 'data/step3_train_data_p2.xlsx'


print('model_name: {}'.format(model_name))
print('batch_size: {}, learning_rate: {}'.format(batch_size, lr))
...
output_model_name = 'model/step3_p2({}_{}_{}).pt'.format(
